            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="bg-white shadow-sm rounded-lg mb-6 overflow-hidden">
                    <div class="p-6 border-b border-gray-200">
                        <h3 class="text-lg font-medium mb-4">Settlements</h3>
                        <div v-if="settlements.length === 0" class="text-gray-500">
                ...
                <div class="bg-white shadow-sm rounded-lg overflow-hidden">
                    <div class="p-6 border-b border-gray-200">
                        <h3 class="text-lg font-medium mb-4">Expense History</h3>
